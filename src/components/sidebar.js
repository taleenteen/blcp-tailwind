      ...
      <div id="sidebar-content" class="fixed left-0 top-0 h-screen w-64 bg-white shadow-lg transform transition-transform duration-300 z-50 overflow-y-auto ${
        ...
        <div class="p-4 pt-20 lg:pt-4">
          ...
          <nav class="space-y-1">
            ...
            <!-- Portfolio Section -->
            <div class="sidebar-section">
              <a href="#portfolio" class="sidebar-link flex items-center px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600 rounded-lg transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                </svg>
                ${this.translations[this.currentLang].nav.portfolio}
              </a>
            </div>
