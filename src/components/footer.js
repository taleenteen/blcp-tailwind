      ...
      <footer class="bg-gray-800 text-white py-12 mt-12">
        <div class="max-w-7xl mx-auto px-4">
          <div class="grid md:grid-cols-3 gap-8">
            <div>
              <h3 class="text-xl font-bold mb-4">${
                this.translations[this.currentLang].footer.company
              }</h3>
              <p class="text-gray-300 mb-2">${
                this.translations[this.currentLang].footer.address
              }</p>
              <p class="text-gray-300 mb-2">${
                this.translations[this.currentLang].footer.phone
              }</p>
              <p class="text-gray-300">${
                this.translations[this.currentLang].footer.email
              }</p>
            </div>
          ...
          <div class="border-t border-gray-700 mt-8 pt-8 text-center">
            <p class="text-gray-300">${
              this.translations[this.currentLang].footer.copyright
            }</p>
          </div>
        </div>
      </footer>
